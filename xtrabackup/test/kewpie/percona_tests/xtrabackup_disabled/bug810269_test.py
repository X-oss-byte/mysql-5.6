...
class basicTest(mysqlBaseTestCase):
    ...
    def test_bug810269(self):
        ...
        queries = [
            ...
            f"ALTER TABLE {table_name} ENGINE=InnoDB ROW_FORMAT=compressed KEY_BLOCK_SIZE=4",
        ]
        ...
        self.assertEqual(
            orig_checksum,
            restored_checksum,
            f"{orig_checksum} || {restored_checksum}",
        )
